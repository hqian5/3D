...
public class Anilamp extends JFrame implements ActionListener {
    ...
    public Anilamp(String textForTitleBar) {
        ...
        camera = new mainAssignment.Camera(mainAssignment.Camera.DEFAULT_POSITION, mainAssignment.Camera.DEFAULT_TARGET, mainAssignment.Camera.DEFAULT_UP);
        glEventListener = new Lamp_GLEventListener(camera);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equalsIgnoreCase("camera X")) {
            camera.setCamera(mainAssignment.Camera.CameraType.X);
            canvas.requestFocusInWindow();
        }
        else if (e.getActionCommand().equalsIgnoreCase("camera Z")) {
            camera.setCamera(mainAssignment.Camera.CameraType.Z);
            canvas.requestFocusInWindow();
        }
